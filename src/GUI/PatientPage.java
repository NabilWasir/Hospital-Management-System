...
public class PatientPage extends JFrame implements ActionListener {
    ...
    private JTextField nameTextfield, ageTextfield, idTextfield, genderTextfield, diseaseTextfield, searchTextfield;
    ...
    public PatientPage(HomePage home, PatientList patientList){
    ...
    private void saveDataToFile() {
        try {
            ...
            System.out.println("Error saving patient data: " + ex.getMessage());
        }
    }
    ...
    public void initializeFrame(){
        ...
        diseaseLabel.setFont(MyFont.labelFont);
        diseaseLabel.setBounds(15,334,300,40);
        diseaseLabel.setForeground(MyColor.blue);
        ...
        diseaseTextfield.setFont(MyFont.textFieldFont);
        diseaseTextfield.setBounds(15,375,300,40);
        diseaseTextfield.setBorder(new RoundBorder(20, 1, MyColor.blue));
        ...
        // Search Button - keeping original dimensions
        ...
        // Search TextField - keeping original dimensions
            ...
            for(int i = 0; i < patients.length; i++){
                if(patients[i] != null){
                    model.addRow(new Object[]{
                            toUpperCase(patients[i].getName()),
                            patients[i].getAge(),
                            toUpperCase(patients[i].getGender()),
                            patients[i].getId(),
                            toUpperCase(patients[i].getDisease())
                    });
                }
            }
        }
    ...
    private void searchPatient() {
        ...
        // If not found by ID or input is not numeric, search by Name
    ...
    public void actionPerformed(ActionEvent e){
        if(addButton == e.getSource()){
            try {
                if (nameTextfield.getText().trim().isEmpty() || genderTextfield.getText().trim().isEmpty() || diseaseTextfield.getText().trim().isEmpty()) {
                ...
                String disease = toUpperCase(diseaseTextfield.getText().trim());

                Entity.Patient p = new Entity.Patient(name, age, gender, id, disease);
    ...
    public void tableModelToList() {
        ...
        for (int i = 0; i < rows; i++) {
            ...
            String disease = toUpperCase(table.getModel().getValueAt(i, 4).toString());

            Patient patient = new Patient(name, age, gender, id, disease);
            updatedList.insertPatient(patient);
        }
